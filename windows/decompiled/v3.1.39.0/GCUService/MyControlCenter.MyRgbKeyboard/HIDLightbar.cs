...
internal class HIDLightbar : HIDKeyboard
{
	...
	public HIDLightbar(LM_Manager lm_Manger, string fwVersion)
	...
	public override void AsyncWelcome()
	{
		try
		{
			...
			LogCtrl.TraceMessage("data[0]: " + string.Join(",", lightbarWelcomeEffect[0]), "AsyncWelcome", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyRgbKeyboard\\HIDKeyboard\\HIDLightbar.cs", 61);
			LogCtrl.TraceMessage("data[1]: " + string.Join(",", lightbarWelcomeEffect[1]), "AsyncWelcome", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyRgbKeyboard\\HIDKeyboard\\HIDLightbar.cs", 62);
	...
	public override void SetBrinessByScanCode(int scancode)
	{
		if (scancode == 175)
		{
			LogCtrl.Write("HIDLighbar : scan code: " + scancode);
