...
internal class ITE_SPEC
{
	...
	internal readonly List<ushort> PIDList = new List<ushort> { 52736, 24576, 24577, 24578, 24579, 24580, 24582, 24583 };

	internal readonly List<ushort> LBPIDList = new List<ushort> { 24581, 24584 };
