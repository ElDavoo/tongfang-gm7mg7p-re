...
internal class FanModel_000 : BaseFanModel
{
	...
	public FanModel_000(string modelname, string TargetName, List<ModelType> datas)
	...
	public override void Run(int lastDuty)
	{
		...
		CaculateIndex.MAP(DataConverter(list), 3);
		CPUTMap1 = CaculateIndex.MAP(DataConverter(list), 1);
		num = FindDegredd(CPUTMap1.Last()).Value;
