...
internal class MyFanManager_RamFan1p5_CML : MyFanManager
{
	...
	public override void EnableByService(Dispatcher dispatcher = null)
	{
		...
		LogCtrl.TraceMessage("g_TurboModeSupport: " + g_TurboModeSupport, "EnableByService", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 82);
		m_DefaultMode = GetDefaultMode();
		LogCtrl.TraceMessage("m_DefaultMode: " + m_DefaultMode, "EnableByService", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 85);
		g_QkeyDefine = GetQkeyDefine();
		LogCtrl.TraceMessage("g_QkeyDefine: " + g_QkeyDefine, "EnableByService", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 88);
		m_FanBoostBtnSupport = CustomizeCtrl.GetFanBoostBtnSupport();
		LogCtrl.TraceMessage("m_FanBoostBtnSupport: " + m_FanBoostBtnSupport, "EnableByService", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 91);
		m_IsNvGpu = UtilityExtensions.IsNvGpu();
		LogCtrl.TraceMessage("m_IsNvGpu: " + m_IsNvGpu, "EnableByService", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 94);
		LoadProfileAll();
		syncBiosSettings();
		Init();
		m_bInit = true;
	...
	public override void Disable()
	{
		...
		m_DefaultMode = GetDefaultMode();
		LogCtrl.TraceMessage("m_DefaultMode: " + m_DefaultMode, "Disable", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 107);
	...
	public override async void Receive(byte[] data)
	{
		...
		LogCtrl.TraceMessage("---------------" + LogCtrl.GetTime() + "---------------", "Receive", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 117);
		LogCtrl.TraceMessage("Action = " + text, "Receive", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 118);
		switch (text)
		{
		case "GETSTATUS":
			if (m_bInit)
	...
	private void LoadProfileAll()
	{
		...
		if (m_IsNvGpu)
		{
			...
			LogCtrl.TraceMessage("NV API WhisperModeSupport: " + m_GpuWhisperModeSupport, "LoadProfileAll", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 417);
		}
	...
	private void RefreshCustomizeDefaultValues()
	{
		...
		RefreshCpuFeatureValidValues(ref M1T1_CustomizeValues, PL, PL2, PL1_dc, PL2_dc, GamingModePLDefaultValue);
		FanTable.GetPLDefaultValue("M1T2", ref PL, ref PL2, ref PL1_dc, ref PL2_dc);
		RefreshCpuFeatureValidValues(ref M1T2_CustomizeValues, PL, PL2, PL1_dc, PL2_dc, GamingModePLDefaultValue);
		FanTable.GetPLDefaultValue("M1T3", ref PL, ref PL2, ref PL1_dc, ref PL2_dc);
		RefreshCpuFeatureValidValues(ref M1T3_CustomizeValues, PL, PL2, PL1_dc, PL2_dc, GamingModePLDefaultValue);
		...
		RefreshGpuFeatureValidValues(ref M1T1_CustomizeValues, DB, WM);
		FanTable.GetGpuFeatureDefaultValue("M1T2", ref DB, ref WM);
		RefreshGpuFeatureValidValues(ref M1T2_CustomizeValues, DB, WM);
		FanTable.GetGpuFeatureDefaultValue("M1T3", ref DB, ref WM);
		RefreshGpuFeatureValidValues(ref M1T3_CustomizeValues, DB, WM);
	...
	private void RefreshGpuFeatureValidValues(ref CustomizeValues customizeValues, string DB, string WM)
	{
		try
		{
			if (DB.Contains("NA"))
	...
	private void CreateMainOption(MainOption option)
	{
		...
		{
			LogCtrl.TraceMessage("Exception" + ex.Message, "CreateMainOption", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 680);
		}
	}
	...
	private void CreateModeProfiles(ModeProfile profile)
	{
		...
		{
			LogCtrl.TraceMessage("Exception" + ex.Message, "CreateModeProfiles", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 698);
		}
	}
	...
	private void WriteMainOptionToJson(string key, uint value)
	{
		...
		{
			LogCtrl.TraceMessage("Exception" + ex.Message, "WriteMainOptionToJson", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 750);
		}
	}
	...
	private void WriteProfileToJson(ModeProfile profile)
	{
		...
		{
			LogCtrl.TraceMessage("Exception" + ex.Message, "WriteProfileToJson", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 766);
		}
	}
	...
	private void syncBiosSettings()
	{
		...
		LogCtrl.TraceMessage("PowerMode = 0x" + num.ToString("X2"), "syncBiosSettings", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 777);
		if (num != 255)
		{
			if (m_Option.OperatingMode != num)
			{
				LogCtrl.TraceMessage("Change local Power Mode.", "syncBiosSettings", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 783);
		...
		{
			LogCtrl.TraceMessage("NvramVariable Power Mode = 0XFF, then change to default Power Mode.", "syncBiosSettings", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 790);
			m_Option.OperatingMode = m_DefaultMode;
			WriteMainOptionToJson("OperatingMode", m_Option.OperatingMode);
		}
	}
	...
	private void Init()
	{
		LogCtrl.TraceMessage("OperatingMode = " + m_Option.OperatingMode + ", " + OperatingModeString(m_Option.OperatingMode), "Init", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 820);
		RefreshCurrentProfile(m_Option.OperatingMode, save: false);
	...
	private void SetGpuDynamicBoostSwitch(int status)
	{
		if (status == 1)
		{
			cGpuFeatures.SetGpuDynamicBoostTotalProcessingPowerTarget(25);
	...
	private void SetGpuWhisperModeSwitchOnOFF(int status)
	{
		...
		if (status == 1)
		{
			...
			LogCtrl.TraceMessage("SetGpuWhisperModeStatus: " + status + ", SetGpuWhisperModeSettingValue: " + m_Option.WhisperModeSetting, "SetGpuWhisperModeSwitchOnOFF", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1141);
		}
		else
		{
			cGpuFeatures.SetGpuWhisperModeStatus(status: false);
			LogCtrl.TraceMessage("SetGpuWhisperModeStatus: " + status, "SetGpuWhisperModeSwitchOnOFF", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1147);
		}
	}
	...
	private uint GetFanMode()
	{
		...
		LogCtrl.TraceMessage($"EC 0751 bit4[{bitFromByte}], bit7[{bitFromByte2}]", "GetFanMode", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1258);
		return result;
	}
	...
	private void SetGPUdstate(uint dstate)
	{
		...
		LogCtrl.TraceMessage("Set D-State to: " + dstate, "SetGPUdstate", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1348);
	}
	...
	private void SetGPUdstateByGpuMode(uint G)
	{
		...
		LogCtrl.TraceMessage("Set D-State to: " + num, "SetGPUdstateByGpuMode", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1379);
	}
	...
	private void SetPowerLedStatus(uint mode)
	{
		...
		b3 = (byte)((Data & b) + b2);
		LogCtrl.TraceMessage("Mode: " + mode + ", Set ECRAM 0x" + ((ushort)1957).ToString("X") + " = 0x" + b3.ToString("X2"), "SetPowerLedStatus", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1461);
	...
	private void SetFanQuietModeEnable(bool bEnable)
	{
		...
		EcCtrl.Read(GetType().Name, 1957, ref Data);
		b3 = (byte)((Data & b) + b2);
		LogCtrl.TraceMessage("bEnable " + bEnable + ", Set ECRAM 0x" + ((ushort)1957).ToString("X") + " = 0x" + b3.ToString("X2"), "SetFanQuietModeEnable", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1482);
		EcCtrl.Write(GetType().Name, 1957, b3);
	}
	...
	private void SetOverBoostMode(bool bEnable)
	{
		...
		EcCtrl.Read(GetType().Name, 1957, ref Data);
		b3 = (byte)((Data & b) + b2);
		LogCtrl.TraceMessage("bEnable " + bEnable + ", Set ECRAM 0x" + ((ushort)1957).ToString("X") + " = 0x" + b3.ToString("X2"), "SetOverBoostMode", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1503);
		EcCtrl.Write(GetType().Name, 1957, b3);
	}
	...
	private void SetPowerStatus(bool bHigh)
	{
		...
		EcCtrl.Read(GetType().Name, 1957, ref Data);
		b3 = (byte)((Data & b) + b2);
		LogCtrl.TraceMessage("bHigh " + bHigh + ", Set ECRAM 0x" + ((ushort)1957).ToString("X") + " = 0x" + b3.ToString("X2"), "SetPowerStatus", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1524);
		EcCtrl.Write(GetType().Name, 1957, b3);
	}
	...
	private void SetOverBoostByDynamicTemp(bool bEnable)
	{
		...
		b3 = (byte)((Data & b) + b2);
		LogCtrl.TraceMessage("bEnable " + bEnable + ", Set ECRAM 0x" + ((ushort)1958).ToString("X") + " = 0x" + b3.ToString("X2"), "SetOverBoostByDynamicTemp", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1547);
	...
	private void GetGamingPLDefaultValue(ref int PL1, ref int PL2, ref int PL4, ref int DState)
	{
		...
		LogCtrl.TraceMessage("PL1:" + PL1 + ", PL2:" + PL2 + ", PL4:" + PL4 + ", DState:" + DState, "GetGamingPLDefaultValue", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1567);
	}
	...
	private void GetOfficePLDefaultValue(ref int PL1, ref int PL2, ref int PL4, ref int DState)
	{
		...
		PL4 = (int)(Convert.ToUInt64(Data3) & 0xFF);
		DState = (int)(Convert.ToUInt64(Data4) & 0xFF);
		LogCtrl.TraceMessage("PL1:" + PL1 + ", PL2:" + PL2 + ", PL4:" + PL4 + ", DState:" + DState, "GetOfficePLDefaultValue", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1584);
	}
	...
	private void GetTurboPLDefaultValue(ref int PL1, ref int PL2, ref int PL4, ref int DState)
	{
		...
		PL4 = (int)(Convert.ToUInt64(Data3) & 0xFF);
		DState = (int)(Convert.ToUInt64(Data4) & 0xFF);
		LogCtrl.TraceMessage("PL1:" + PL1 + ", PL2:" + PL2 + ", PL4:" + PL4 + ", DState:" + DState, "GetTurboPLDefaultValue", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1601);
	}
	...
	private void SkipFanSafetyAbnormalProtection(int status)
	{
		...
		LogCtrl.TraceMessage("status:" + status, "SkipFanSafetyAbnormalProtection", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1637);
	}
	...
	private async void SetFanTableThread(string _tableName)
	{
		...
		LogCtrl.TraceMessage(_tableName, "SetFanTableThread", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1736);
	...
	{
		LogCtrl.TraceMessage("modeProfileIndex: " + _modeProfileIndex, "SetOperatingModeProfileIndex", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1795);
	...
	private async void SetOperatingModeProfileIndexThread(string _modeProfileIndex)
	{
		...
		LogCtrl.TraceMessage(_modeProfileIndex, "SetOperatingModeProfileIndexThread", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1857);
	...
	private void SetModeSwitchChange()
	{
		if (g_TurboModeSupport == 0)
		{
			...
			case 1u:
				...
				LogCtrl.TraceMessage("-----------------------------------SetModeSwitchChange to Office----", "SetModeSwitchChange", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1988);
				UserSet_Mode2();
				break;
			case 0u:
				App.m_Osd.ShowOSDByName(TransToGlobalType(1u));
				LogCtrl.TraceMessage("-----------------------------------SetModeSwitchChange to Gaming----", "SetModeSwitchChange", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 1993);
				UserSet_Mode1();
				break;
			}
		}
		else
		{
			...
			case 1u:
				...
				LogCtrl.TraceMessage("-----------------------------------SetModeSwitchChange to Turbo----", "SetModeSwitchChange", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 2004);
				UserSet_Mode3();
				break;
			case 0u:
				App.m_Osd.ShowOSDByName(TransToGlobalType(1u));
				LogCtrl.TraceMessage("-----------------------------------SetModeSwitchChange to Gaming----", "SetModeSwitchChange", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 2009);
				UserSet_Mode1();
				break;
			case 2u:
				App.m_Osd.ShowOSDByName(TransToGlobalType(0u));
				LogCtrl.TraceMessage("-----------------------------------SetModeSwitchChange to Office----", "SetModeSwitchChange", "D:\\_work\\ControlCenter3_1\\Service\\MyControlCenter\\MyControlCenter\\MyFan\\MyFanManager_RamFan1p5_CML.cs", 2014);
				UserSet_Mode2();
				break;
			}
		}
