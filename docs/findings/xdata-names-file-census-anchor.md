...
| `TheNamesFile`'s class docstring, *"the editable surface, and it is anchored"* | `ec/tools/test_xdata_cluster_names.py:898` |
...
nothing reads it. `test_xdata_cluster_names.py:910-916` requires the column
