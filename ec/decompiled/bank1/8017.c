// bank1 @ 8017   dec_06d1_value   [named]
...
/* One instruction: dec A, decrementing the value read from XDATA 0x06D1 at 0x8014, reached only
   when that byte was non-zero because the jz at 0x8015 skips over it. The store that commits the
...
void dec_06d1_value(char param_1,char *param_2,char param_3)
