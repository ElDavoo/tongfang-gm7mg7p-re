...
/* A single LJMP 0xD085, with no instruction of its own. Nothing is read, written or computed at
   0xF79C: the body in the C file (the compare on XDATA 0x00E2, the calls, the writes to 0x0AE3 and
