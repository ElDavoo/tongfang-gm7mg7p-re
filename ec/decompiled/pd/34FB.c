// pd @ 34FB   read_byte_to_r7_base_0408   [named]
...
/* Handoff helper reached by 5 of the 0x07D0 sites: it reads the byte at DPTR keeps it in R7 and
   points DPTR at 0x0408 which is the base the file names for the 0x60-byte records. Only those
