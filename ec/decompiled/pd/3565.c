// pd @ 3565   dptr_0418_plus_60a   [named]
...
/* Reads the byte at the caller's DPTR into A, saves it in R7, reloads DPTR with 0x418, then
   tail-jumps to 0x10BC, which adds A*B to DPTR. With B = 0x60 the resulting pointer is 0x418 plus
...

{
  ...
  add_full_product_to_dptr(0x418,0x60,*param_1);
}
